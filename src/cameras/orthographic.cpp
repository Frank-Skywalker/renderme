...
namespace renderme
{
	...
	auto Orthographic_Camera::process_keyboard_input(Camera_Movement move, float delta_time)->void
	{
		switch (move) {
	...
	auto Orthographic_Camera::process_mouse_input(Float xoffset, Float yoffset)->void
	{
